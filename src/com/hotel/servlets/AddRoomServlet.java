...
public class AddRoomServlet extends HttpServlet {
    ...
    public String getImagesDir() {
        try {
            ...
            imagesDir =  imagesDir.substring(0, imagesDir.indexOf("\\SummaryTask4\\")+"\\SummaryTask4".length()).concat("\\web\\Images");
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        //do if they are equal to zero
            ...
            try{
                Room room = dbProxy.insertRoom(roomNumber, category, price, capacity, "Available");
                int roomId = dbProxy.getId(roomNumber, dbProxy.getQuerySelectIdFromRooms());

                for (String image: images) {
                    Image picture =  dbProxy.insertImage(image, roomId);
