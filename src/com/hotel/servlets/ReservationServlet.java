    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
       ...
       try{
           ...
           if(dateEnd.before(dateBegin)){
               ...
               dbProxy.insertInJournal(login, room, new java.sql.Date(dateBegin.getTime()), new java.sql.Date(dateEnd.getTime()));
               Room reservedRoom = dbProxy.changeState("Reserved", room);
