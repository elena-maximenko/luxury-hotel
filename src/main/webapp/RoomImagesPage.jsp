...
<div id="wrapper">
    <%
        ...
        if (request.getAttribute("room") != null){
            ...
            images = DBProxy.getInstance().getImagesByRoomNumber(room);
        }
    %>
    ...
    <div id="entityBlock" style="position: fixed; top: 30px; height: 550px">
        ...
        <%
            ...
            if(!(boolean)httpSession.getAttribute("isReservedEarlier")) {%>
        ...
        <%}else {%>
        <form style="top: 450px; position: fixed; right: 75px; width: 250px" method="get" action="reserved-earlier">
            <button class="button-submit-with-icon" style="cursor: hand; width: 300px; height: 30px" type="submit">
                <span style="font: bolder 20px Constantia, serif; color: white; text-decoration: underline">Back to reserved rooms</span>
            </button>
        </form>
        <%}%>
        <%
